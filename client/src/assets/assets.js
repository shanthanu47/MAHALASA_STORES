...
import main_banner_bg from "./tulunad_hero_desktop.png";
import main_banner_bg_sm from "./tulunad_hero_mobile.png";
import bottom_banner_image from "./tulunad_bottom_banner_desktop_v2.png";
import bottom_banner_image_sm from "./tulunad_bottom_banner_mobile.png";
import add_address_iamge from "./add_address_image.svg";
import organic_vegitable_image from "./tulunad_vegetables_fruits_v2.png";
import fresh_fruits_image from "./tulunad_vegetables_fruits_v2.png";
import bottles_image from "./bottles_image.png";
import pickles_image from "./tulunad_pickles.png";
import sweets_image from "./tulunad_sweets.png";
import snacks_image from "./tulunad_snacks.png";
import maggi_image from "./maggi_image.png";
import dairy_product_image from "./dairy_product_image.png";
import bakery_image from "./bakery_image.png";
import grain_image from "./tulunad_grains.png";
...
import spices_image from "./tulunad_hero_mobile.png";
import lentils_image from "./tulunad_lentils_beans.png";
...
export const footerLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { text: "Contact Us", url: "/contact" },
      { text: "Store Location", url: "/contact" },
    ],
  },
  {
    title: "Categories",
    links: [
      { text: "Fresh Fruits", url: "/products/fruits" },
      { text: "Vegetables", url: "/products/vegetables" },
      { text: "Dairy Products", url: "/products/dairy" },
      { text: "Beverages", url: "/products/beverages" },
    ],
  },
  {
    title: "Contact Info",
    links: [
      { text: "📞 +91 8310781274", url: "tel:+918310781274" },
      { text: "📱 +91 9379852711", url: "tel:+919379852711" },
      { text: "✉️ Contact Email", url: "mailto:shanthanushenoy8511@gmail.com" },
      { text: "📍 Store Address", url: "/contact" },
    ],
  },
];
