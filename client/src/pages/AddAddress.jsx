...
const AddAddress = () => {
    ...
    const onSubmitHandler = async (e) => {
        e.preventDefault();
        try {
            const { data } = await axios.post('/api/address/save', { address });
    ...
    return (
        <div className='mt-16 pb-16'>
            <p className='text-2xl md:text-3xl text-gray-500'>
                Manage Shipping <span className='font-semibold text-primary'>Address</span>
            </p>
            <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
                <div className='flex-1 max-w-md'>
                    <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            <InputField handleChange={handleChange} value={address.zipcode} name='zipcode' type="number" placeholder="Zip code" />
